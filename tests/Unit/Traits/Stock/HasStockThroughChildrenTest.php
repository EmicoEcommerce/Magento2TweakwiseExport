...
namespace Tweakwise\Test\Unit\Traits\Stock;
...
class HasStockThroughChildrenTest extends Unit
{
    ...
    public function testCombinedStockItemKeepsParentOrderFields(): void
    {
        ...
        $parent = new ExportEntityConfigurable(
            $store,
            $storeManager,
            $stockConfiguration,
            $visibility,
        ...
        self::assertSame(10, $combined->getQty());
