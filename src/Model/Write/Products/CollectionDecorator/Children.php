...
class Children implements DecoratorInterface
{
    ...
    protected function addChild(
        ...
        $this->addConfigurableChildToCollection($collection, $parent, $child, $childId); // @phpstan-ignore-line
        $this->addChildToParent($parent, $child); // @phpstan-ignore-line
        $this->enrichGroupedExportChild($collection, $parent, $parentId, $childId); // @phpstan-ignore-line
    }
